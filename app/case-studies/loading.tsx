    ...
    <div className="min-h-screen">
      ...
      <main className="pt-28 pb-28">
        ...
        <section className="px-6 md:px-16 max-w-7xl mx-auto mb-20 relative">
          ...
          <div className="w-20 h-3 bg-secondary/20 rounded animate-pulse mb-5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <GlassCard key={i} className="h-full">
                ...
                <div className="w-20 h-5 bg-outline/10 rounded animate-pulse mb-4" />
