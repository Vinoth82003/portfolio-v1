        ...
        components={{
          code({ node, inline, className, children, ...props }: any) {
            ...
            return !inline && match ? (
              ...
              <code className={`${className} bg-surface-high px-1.5 py-0.5 rounded`} {...props}>
                {children}
              </code>
            );
          },
          ...
          p: ({ children }) => <p className="font-body leading-relaxed mb-4">{children}</p>,
          ul: ({ children }) => <ul className="list-disc pl-6 mb-4 space-y-2">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal pl-6 mb-4 space-y-2">{children}</ol>,
          li: ({ children }) => <li className="font-body">{children}</li>,
          blockquote: ({ children }) => (
          ...
          td: ({ children }) => <td className="p-3 border-b border-outline/5 font-body">{children}</td>,
          img: ({ src, alt }) => (
